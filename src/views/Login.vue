    ...
    <div class="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
      <div class="mb-8 text-center">
        <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-100">
          <span class="text-3xl font-bold text-emerald-600">J</span>
        </div>
        <h1 class="text-2xl font-bold text-gray-900">JRV Inventory</h1>
        <p class="mt-1 text-sm text-gray-500">Control de inventario</p>
      </div>
